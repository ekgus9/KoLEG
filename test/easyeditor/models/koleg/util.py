...
def encode_koleg_facts(sentence_model: SentenceTransformer, ds: Dataset, hparams: KoLEGHyperParams):
...
def encode_koleg_facts_multimodal(sentence_model: SentenceTransformer, ds: Dataset, hparams: KoLEGMultimodalHyperParams):
